AgilePHP.Studio.Menubar.help.About = {

	window : new Ext.Window(
			{

				id : 'studio-about-window',
				...
				html : '<div id="aboutWindow" style="background-color: #000000; height: 300px;">'
						...
						+ '<img src="'
						+ AgilePHP.getDocumentRoot()
						+ 'view/images/logo.png" style="float: left; padding: 10px 10px 20px 10px;">'
						+ '</a>'
						+ '<div style="float: left; padding-left: 290px; padding-right: 25px; padding-top: 15px; color: #FFFFFF">'
						+ '<div style="font-weight: bolder;">'
						+ AgilePHP.Studio.appName
						+ '</div>'
						+ '<div style="font-weight: bolder;">Version: '
						+ AgilePHP.Studio.version
						+ '</div>'
				...
				buttons : [ {
					text : 'Close',
					handler : function() {
						AgilePHP.Studio.Menubar.help.About.window.hide();
					}
				} ]
			}),

	show : function() {
		AgilePHP.Studio.Menubar.help.About.window.show(this);
	}
};