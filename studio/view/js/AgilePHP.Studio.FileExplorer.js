			        ...
			        listeners: {
			            ...
			            contextmenu: function(node, e) {
			                ...
			                if(node.isLeaf()) {
			                	...
			                	if(Ext.get('file-explorer-contextmenu-build'))
		                			Ext.getCmp('file-explorer-contextmenu-build').destroy();
			                	...
			                	pieces.pop();
			                	if(pieces.pop() == 'components') {

			                		Ext.getCmp('file-explorer-contextmenu').add({
		                    			id: 'file-explorer-contextmenu-build',
		                    			text: 'Build',
		                    			iconCls: 'btn-build'
		                    		 });
			                	}
