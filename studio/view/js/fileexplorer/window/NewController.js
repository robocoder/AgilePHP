AgilePHP.Studio.FileExplorer.NewController = function() {

	var id = 'fe-new-controller';
	var controllersUrl = AgilePHP.getRequestBase() + '/FileExplorerController/getControllerTemplates';
	var modelsUrl = AgilePHP.getRequestBase() + '/FileExplorerController/getModels/' + AgilePHP.Studio.FileExplorer.getSelectedProject();
	...
	var win = new AgilePHP.Studio.Window( id, 'btn-new-controller', 'New Controller' );
		win.add( new Ext.FormPanel({
	  		id: id + '-form',
	  		url: AgilePHP.getRequestBase() + '/FileExplorerController/createController/' + AgilePHP.Studio.FileExplorer.getSelectedProject(), 
	  		frame: true,
	  		monitorValid: true,
	  		labelWidth: 1,
	  		defaults: {
