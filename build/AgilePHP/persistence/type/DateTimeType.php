...
/**
 * AgilePHP interceptor responsible for type casting a value to a PHP/SQL compatible Date type
 * 
 * @author Jeremy Hahn
 ...
 * <code>
 * #@DateTimeType
 * public function setMyDatetime( $value ) {
 * 
...
class DateTimeType {
	  ...
	  /**
	   * Casts the first input parameter to a SQL DateTime type
	   * 
	   * @param InvocationContext $ic The intercepted invocation context
	   * @return mixed InvocationContext The modified InvocationContext containing the casted DateTime value
	   */
	  #@AroundInvoke
	  public function cast( InvocationContext $ic ) {

	  		 if( !$ic->getParameters() )
	  		 	 throw new AgilePHP_InterceptionException( '#@DateType::cast Requires a method which accepts at least one parameter.' );
	  	     ...
	  	     $params[0] = date( 'Y-m-d H:i:s', $params[0] );
