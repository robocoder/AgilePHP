...
/**
 * AgilePHP interceptor responsible for type casting a value to a PHP/SQL compatible float
 * 
 * @author Jeremy Hahn
 ...
 * <code>
 * #@FloatType
 * public function setMyNumber( $value ) {
 * 
 * 		  $this->myFloat = $value;
 * }
 * </code>
...
class FloatType {
	  ...
	  /**
	   * Casts the first input parameter to a PHP float
	   * 
	   * @param InvocationContext $ic The interceptor invocation context
	   * @return mixed InvocationContext The modified InvocationContext containing the casted float value
	   */
	  #@AroundInvoke
