...
AgilePHP.IDE.Menubar.tools.DatabaseManager.Compare = function() {
	...
	//if( !AgilePHP.IDE.Window.Tools.DatabaseManager.databases.length ) {
		...
		var stub = AgilePHP.Remoting.getStub( 'DatabaseManagerRemote' );
			stub.setCallback( AgilePHP.IDE.Menubar.tools.DatabaseManager.Compare.remoteDatabasesHandler );
...
AgilePHP.IDE.Menubar.tools.DatabaseManager.Compare.databases = [];

AgilePHP.IDE.Menubar.tools.DatabaseManager.Compare.remoteDatabasesHandler = function( data ) {

	 if( typeof data == 'AgilePHP_RemotingException' ) {

		 AgilePHP.IDE.error( data.message );
		 return false;
	 }

	 AgilePHP.IDE.Menubar.tools.DatabaseManager.Compare.databases = data.servers;
