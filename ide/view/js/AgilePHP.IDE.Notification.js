AgilePHP.IDE.Notification = function( title, message ) {
    ...
    this.createBox = function( t, s ) {
    	...
    	if( AgilePHP.IDE.Notification.notes.length ) {

    		for( var i=0; i<AgilePHP.IDE.Notification.notes.length; i++ ) {
    	...
    	AgilePHP.IDE.Notification.notes.push( title );
	...
	setTimeout( 'AgilePHP.IDE.Notification.notes.pop()', 5000 );
};
AgilePHP.IDE.Notification.notes = [];