...
class IdentityTest extends PHPUnit_Framework_TestCase {
    ...
    public function defaultIdentityTests() {
        ...
        PHPUnit_Framework_Assert::assertInstanceOf('User', Identity::getModel(), 'Failed to get default \'User\' Identity model');
        ...
        Identity::delete();
        $persisted = ORM::find(new User('identity-phpunit'));
        PHPUnit_Framework_Assert::assertTrue(count($persisted) == 0, 'Failed to delete identity-phpunit test user');
