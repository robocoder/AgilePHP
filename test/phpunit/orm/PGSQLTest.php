...
class PGSQLTest extends PHPUnit_Framework_TestCase {
    ...
    public function pgsqlTests() {
        ...
        // $role->persist();  not needed since foreign key configured using cascade="persist-merge"
        ...
        // @todo Not working, need to figure out how to drop postgres database!
        //ORM::drop();
    }
