...
class SprocTest extends PHPUnit_Framework_TestCase {
    ...
    public function sprocTests() {
        ...
        $role2->clear();
        PHPUnit_Framework_Assert::assertInternalType('null', $role2->getId(), 'Failed to clear role2');
        ...
        $role3->clear();
        PHPUnit_Framework_Assert::assertInternalType('null', $role3->getId(), 'Failed to clear role3');
