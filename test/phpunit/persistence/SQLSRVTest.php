...
class SQLSRVTest extends BaseTest {
	  ...
	  public function __construct() {
	  		 ...
	  		 parent::__construct();
	  		 $this->persistence = PersistenceManager::getInstance( 'testcase_sqlsrv' );
	  }

	  public function testPersistenceNotNull() {

	  	     PHPUnit_Framework_Assert::assertNotNull( $this->persistence, 'Failed to create persistence manager for testcase_sqlsrv' );
	  }
