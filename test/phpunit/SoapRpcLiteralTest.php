...
class SoapRpcLiteralTest extends PHPUnit_Framework_TestCase {
 	  ...
 	  public function testArrayStringTest() {
 	      ...
 	      PHPUnit_Framework_Assert::assertInternalType('array', $aTest->strings, 'Unexpected return value for arrayStringTest');
 	  ...
 	  public function testArrayOfObjectsTest() {
 	      ...
 	      PHPUnit_Framework_Assert::assertInternalType('array', $aTest2->MathTests, 'Failed assert arrayOfObjectsTest return value is array');
 	      PHPUnit_Framework_Assert::assertInstanceOf('stdClass', $aTest2->MathTests[0], 'Failed get assert arrayOfObjectsTest element 0 is type MathTest');
 	      PHPUnit_Framework_Assert::assertInstanceOf('stdClass', $aTest2->MathTests[1], 'Failed get assert arrayOfObjectsTest element 1 is type MathTest');
 	  ...
 	  public function testArrayOfArraysTest() {
 	      ...
 	      PHPUnit_Framework_Assert::assertInternalType('array', $aTest3->strings, 'Failed assert arrayOfArraysTest return value is array');
 	      PHPUnit_Framework_Assert::assertInternalType('array', $aTest3->strings, 'Failed assert arrayOfArraysTest return value element[0] is array');
 	      PHPUnit_Framework_Assert::assertInternalType('array', $aTest3->strings[0]->strings, 'failed to find first array element');
 	      PHPUnit_Framework_Assert::assertInternalType('array', $aTest3->strings[1]->strings, 'failed to find second array element');
