...
class AnnotationTest extends PHPUnit_Framework_TestCase {
    ...
    public function getClassLevelAnnotations() {
        ...
        PHPUnit_Framework_Assert::assertInstanceOf('AnnotatedClass', $class, 'Failed to assert type is AnnotatedClass');
        ...
        PHPUnit_Framework_Assert::assertInstanceOf('Simple', $s, 'Failed to assert getAnnotation() returned type Simple for annotation Simple');

        #@TestAnnotation1(name = "Name Value")
        #@TestAnnotation1(name = 'Name Value')
        $ta1 = $class->getAnnotation('TestAnnotation1');
        PHPUnit_Framework_Assert::assertInternalType('array', $ta1, 'Failed to assert getAnnotation() returned array for annotation TestAnnotation1');
        PHPUnit_Framework_Assert::assertInstanceOf('TestAnnotation1', $ta1[0], 'Failed to assert first array element returned by getAnnotation() is an instance of TestAnnotation1');
        PHPUnit_Framework_Assert::assertInstanceOf('TestAnnotation1', $ta1[1], 'Failed to assert second array element returned by getAnnotation() is an instance of TestAnnotation1');
        ...
        PHPUnit_Framework_Assert::assertInternalType('array', $ta3, 'Failed to assert getAnnotation() returned array for annotation TestAnnotation3');
        PHPUnit_Framework_Assert::assertInstanceOf('TestAnnotation3', $ta3[0], 'Failed to assert first array element returned by getAnnotation() is an instance of TestAnnotation3');
        PHPUnit_Framework_Assert::assertInstanceOf('TestAnnotation3', $ta3[1], 'Failed to assert second array element returned by getAnnotation() is an instance of TestAnnotation3');

        PHPUnit_Framework_Assert::assertInternalType('string', $ta3[0]->name, 'Failed to assert TestAnnotation3::name element 1 contains a string value');
        PHPUnit_Framework_Assert::assertInstanceOf('IdentityManager', $ta3[0]->obj1, 'Failed to assert TestAnnotation3::obj1 element 1 is type IdentityManager');
        ...
        PHPUnit_Framework_Assert::assertInternalType('string', $ta3[1]->name, 'Failed to assert TestAnnotation3::name element 2 contains a string value');
        PHPUnit_Framework_Assert::assertInternalType('array', $ta3[1]->name2, 'Failed to assert TestAnnotation3::name2 element 2 contains an array value');
        ...
        PHPUnit_Framework_Assert::assertInstanceOf('IdentityManager', $ta3[1]->obj1, 'Failed to assert TestAnnotation3::obj1 element 2 is type IdentityManager');
    ...
    public function getMethodAnnoationsByMethodName() {
        ...
        PHPUnit_Framework_Assert::assertInstanceOf('TestAnnotation1', $annotations[0], 'Failed to get method1 annotations');
        ...
        PHPUnit_Framework_Assert::assertInternalType('array', $annotations, 'Failed to assert that getAnnotations(\'TestAnnotation3\') on method4 is type array');
    }
    ...
    public function getMethodLevelAnnotations() {
        ...
        PHPUnit_Framework_Assert::assertInternalType('array', $methods, 'Failed to assert AnnotatedClass::getMethods() returned type array');

        #@TestAnnotation2(name = "Name 1 value", name2 = "Name 2 value")
        #@TestAnnotation3(name = "value", name2 = "value 2", obj1 = IdentityManagerFactory::getManager())
        #@TestAnnotation3(name = "Name value", name2 = { key1 = "test", "test2", key3 = 'test3' }, obj1 = IdentityManagerFactory::getManager(), array2 = { newKey = "test", newKey2 = 'test again' }, array3 = { "test", "test2" })
        PHPUnit_Framework_Assert::assertInstanceOf('AnnotatedMethod', $methods[2], 'Failed to assert type is AnnotatedMethod');
        PHPUnit_Framework_Assert::assertInternalType('array', $methods[2]->getAnnotations(), 'Failed to assert AnnotatedMethod object at element 3 contains an array of annotations');
        ...
        PHPUnit_Framework_Assert::assertInstanceOf('IdentityManager', $methods[2]->getAnnotation('TestAnnotation3')->obj1, 'Failed to assert method4\'s first TestAnnotation3::obj1 annotation is type IdentityManager');
    }
    ...
    public function getPropertyLevelAnnotations() {
        ...
        PHPUnit_Framework_Assert::assertInternalType('array', $properties, 'Failed to assert AnnotatedClass::getProperties() returned type array');

        #@TestAnnotation1(name = "value")
        #@TestAnnotation3(name = "Name value", name2 = { key1 = "test", "test2", key3 = 'test3' }, obj1 = IdentityManagerFactory::getManager(), array2 = { newKey = "test", newKey2 = 'test again' }, array3 = { "test", "test2" })
        $foo = $class->getProperty('foo');
        $annotations = $foo->getAnnotations();
        PHPUnit_Framework_Assert::assertInstanceOf('AnnotatedProperty', $foo, 'Failed to assert type is AnnotatedProperty');
        PHPUnit_Framework_Assert::assertInstanceOf('TestAnnotation1', $foo->getAnnotation('TestAnnotation1'), 'Failed to assert property foo annotation element 1 returned type TestAnnotation1');
        PHPUnit_Framework_Assert::assertInstanceOf('TestAnnotation3', $annotations[1], 'Failed to assert property foo annotation element 2 returned type TestAnnotation3');
        ...
        foreach($props as $prop) {
            if($prop->getName() == 'bar') {
                ...
                $bProcessed = true;
                PHPUnit_Framework_Assert::assertInstanceOf('Simple', $prop->getAnnotation('Simple'), 'Failed to assert Simple annotation is of type Simple');
            }
        }
