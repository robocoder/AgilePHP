...
class SoapRpcEncodedTest extends PHPUnit_Framework_TestCase {
 	  ...
 	  public function testArrayStringTest() {
 	      ...
 	      PHPUnit_Framework_Assert::assertInternalType('array', $aTest, 'Unexpected return value for arrayStringTest');
 	  ...
 	  public function testArrayOfObjectsTest() {
 	      ...
 	      PHPUnit_Framework_Assert::assertInternalType('array', $aTest2, 'Failed assert arrayOfObjectsTest return value is array');
 	      PHPUnit_Framework_Assert::assertInstanceOf('MathTest', $aTest2[0], 'Failed get assert arrayOfObjectsTest element 0 is type MathTest');
 	      PHPUnit_Framework_Assert::assertInstanceOf('MathTest', $aTest2[1], 'Failed get assert arrayOfObjectsTest element 1 is type MathTest');
 	  ...
 	  public function testArrayOfArraysTest() {
 	      ...
 	      PHPUnit_Framework_Assert::assertInternalType('array', $aTest3, 'Failed assert arrayOfArraysTest return value is array');
 	      PHPUnit_Framework_Assert::assertInternalType('array', $aTest3[0], 'Failed assert arrayOfArraysTest return value element[0] is array');
 	      PHPUnit_Framework_Assert::assertInternalType('array', $aTest3[1], 'Failed assert arrayOfArraysTest return value element[1] is array');
