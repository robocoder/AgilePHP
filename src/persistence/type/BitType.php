...
/**
 * AgilePHP interceptor responsible for type casting a value to a PHP/SQL compatible bit type
 * 
 * @author Jeremy Hahn
 ...
 * <code>
 * #@BitType
 * public function setMyBit( $value ) {
 * 
 * 		  $this->myBit = $value;
 * }
 * </code>
...
class BitType {
	   ...
	   * @return mixed InvocationContext The modified InvocationContext containing the casted bit value
	   */
	  #@AroundInvoke
	  public function cast( InvocationContext $ic ) {

	  		 if( !$ic->getParameters() )
	  		 	 throw new AgilePHP_InterceptionException( '#@BitType::cast Requires a method which accepts at least one parameter.' );
