...
final class ORM {
    ...
    public static function truncate($model) {
  	 ...
  	 /**
  	  * Attempts to locate the specified model using set fields as where clause criteria.
  	  *
  	  * @param Object $model A domain model object with fields set as the where clause
  	  * @return an array of models matching the criteria or an empty array if the result set was empty
  	  * @throws ORMException
  	  * @static
  	  */
  	 ...
  	 public static function get($model) {
  	     return ORMFactory::getDialect()->get($model);
  	 }
