...
abstract class BaseModelActionController extends BaseModelXslController {
		 ...
		 /**
	   	  ...
	   	  * 
	   	  * @param $msg The exception message. Default is 'Login required'.
	   	  * @return void
	   	  * @throws AgilePHP_NotLoggedInException
	   	  */
	  	 protected function revokeAccess( $msg = 'Login required' ) {

	  	 		   throw new AgilePHP_NotLoggedInException( $msg );
	  	 }
	      ...
	      * @return void
	      */
	     private function setPrimaryKeys( $ids ) {
