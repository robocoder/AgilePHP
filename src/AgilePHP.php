...
final class AgilePHP {
    ...
    private static $debugMode = false;          // Whether or not the application is running in debug mode
    private static $xml;                        // AgilePHP configuration - agilephp.xml
    private static $appName;                    // Name of the application being created
    ...
    private static function parseXml($agilephpDotXml = null) {
        ...
        if(self::$xml->annotations) {
            ...
            spl_autoload_register('AgilePHP::autoload', true, false);
            //spl_autoload_register('AgilePHP::autoload', true, true);
        }
        else
        spl_autoload_register('AgilePHP::autoloadNoAnnotations', true, false);
        //spl_autoload_register('AgilePHP::autoloadNoAnnotations', true, true);
    ...
    public static $classmap = array(
          ...
          'TransformException' => '/data/transformer/TransformException.php',
          ...
          'DataException' => '/data/DataException.php',
          'DataModel' => '/data/DataModel.php',
          'FormParam' => '/form/FormParam.php',
          ...
          'MailerAttachment' => '/mailer/MailerAttachment.php',
          'MailerException' => '/mailer/MailerException.php',
          'MailerListener' => '/mailer/MailerListener.php',
          'MailerMacro' => '/mailer/MailerMacro.php',
          'MailerTemplate' => '/mailer/MailerTemplate.php',
          'AJAXRenderer' => '/mvc/AJAXRenderer.php',
          'BaseController' => '/mvc/BaseController.php',
          'BaseModel' => '/mvc/BaseModel.php',
          ...
          'ClassUtils' => '/util/ClassUtils.php',
          'DocBlockParser' => '/util/DocBlockParser.php',
          'ModelGenerator' => '/util/ModelGenerator.php',
